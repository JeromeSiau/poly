...
RULES: list[tuple[str, list[str] | str]] = [
    ...
    ("src/arb/polymarket_executor", ["run_fear_selling", "run_crypto_td_maker",
                                     ...
                                     "run_sniper"]),
    ("src/feeds/polymarket",        ["run_crypto_td_maker", "run_crypto_td_ml",
                                     "run_crypto_maker", "run_crypto_two_sided_maker",
                                     "run_sniper", "run_slot_collector",
                                     "run_slot_collector_5m"]),
    ("src/feeds/chainlink",         ["run_crypto_td_maker", "run_crypto_td_ml",
                                     "run_slot_collector",
                                     "run_slot_collector_5m"]),
    ("src/feeds/kalshi",            ["run_kalshi_td_maker"]),
    ("src/db/td_orders",            ["run_crypto_td_maker", "run_crypto_td_ml",
                                     "run_kalshi_td_maker",
                                     "run_crypto_two_sided_maker"]),
    ...
    ("src/arb/crypto_td",           ["run_crypto_td_maker", "run_crypto_td_ml"]),
    ...
    ("src/ml/",                     ["run_crypto_td_maker", "run_crypto_td_ml"]),
