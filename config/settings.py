...
class Settings(BaseSettings):
    ...
    POLYMARKET_CLOB_USER_WS: str = "wss://ws-subscriptions-clob.polymarket.com/ws/user"
    ...
    FEAR_SELLING_MIN_YES_PRICE: float = 0.15
    ...
    # === Crypto Two-Sided Arb ===
    CRYPTO_TWO_SIDED_SYMBOLS: str = "BTCUSDT,ETHUSDT"
    CRYPTO_TWO_SIDED_TIMEFRAMES: str = "300,900"
    CRYPTO_TWO_SIDED_MIN_EDGE_PCT: float = 0.01
    CRYPTO_TWO_SIDED_BUDGET_PER_MARKET: float = 200.0
    CRYPTO_TWO_SIDED_MAX_CONCURRENT: int = 8
    CRYPTO_TWO_SIDED_ENTRY_WINDOW_S: int = 30
    CRYPTO_TWO_SIDED_DISCOVERY_LEAD_S: int = 15
    CRYPTO_TWO_SIDED_POLL_INTERVAL_S: float = 2.0
    CRYPTO_TWO_SIDED_FEE_BPS: int = 100
    CRYPTO_TWO_SIDED_PAPER_CAPITAL: float = 2000.0
