...
#
# Discovers BTC/ETH 15-min binary markets via Gamma /events API
# and runs the same two-sided inventory engine used for sports,
# but tuned for short-lived crypto markets.
#
# Args:
...
# Dynamic sizing from wallet (same ratios as run_two_sided.sh):
